...
function ProfileStartLayout({ formik, loading, sTData, sTLoading, pOData, pOLoading }) {
	return (
		<form className="f f-c g8" onSubmit={formik.handleSubmit} onReset={formik.handleReset}>
			...
			<Box
				className="f align-center justify-end flex-wrap"
			...
			>
				<Box className="f g12">
					<Button
						id="survey_form_step_two_go_back"
						className="track_button"
						variant="outlined"
						color="gray"
						type="reset"
						component={Link}
						to="/provider/profile-form/professional"
					>
						Go back
					</Button>
					<Button
						id="survey_form_step_two_save_and_continue"
						className="track_button"
						type="submit"
						variant="contained"
						color="purple"
					...
					>
						{formik.isSubmitting ? "Please wait..." : "Save & continue"}
					</Button>
				</Box>
			</Box>
		</form>
...
export default ProfileStartLayout
